  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
      ...
      <Box sx={{marginTop:"15rem"}}>
        ...
        <Link to={`/PageFive`}><Button variant="contained" color="secondary" sx={{ typography: "h3", color: "black", width: "20rem", padding: "1rem 0rem", fontFamily: "Bebas Neue" }}>Verder</Button></Link>
      </Box>
    </Box>
  );
}
